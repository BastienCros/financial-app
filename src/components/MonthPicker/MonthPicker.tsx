 ...
 *
 * @param availableMonths - Sorted array of month strings in "YYYY-MM" format
 * @param selectedMonth - Currently selected month in "YYYY-MM" format
...
const getMonthWindow = (
    ...
    if (selectedMonthIndex === -1) {
        throw new Error(`Month ${selectedMonth} not found in available months`);
    }
